...
import { Briefcase, Clock, LockKeyhole, Vault, RefreshCcw, BadgeCheck } from 'lucide-react';
  ...
  return (
    <main className="px-4 py-12 max-w-6xl mx-auto">
      <section className="text-center mb-24">
        <h1 className="text-4xl font-bold mb-3 text-blue-900">Secure AI Agent Experiences with Auth0</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          <a href="https://auth0.com/ai/docs/user-authentication" className="btn btn-outline-primary" target="_blank" rel="noreferrer">
            Read Docs
          </a>
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {useCases.map(({ title, description, icon: Icon, href }) => (
            <Link href={href} key={title} className="border rounded-lg p-6 shadow-sm hover:shadow-md transition bg-white">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-8 text-center text-gray-800">How It Works</h2>
